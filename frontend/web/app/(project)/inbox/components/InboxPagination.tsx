...
import { INBOX_PAGE_SIZE_OPTIONS } from '../constants';
...
export function InboxPagination({
  ...
  return (
    <nav
      aria-label="Chat inbox pagination"
      className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between border border-cu-border rounded-2xl bg-cu-bg-secondary/40 px-4 py-3 sm:px-6 shadow-cu-sm"
    >
      ...
      <div className="flex flex-wrap items-center gap-3 text-xs sm:text-sm text-cu-text-secondary">
        ...
        <div className="text-xs font-medium">
          ...
          of <span className="font-bold text-cu-text-primary">{totalItems}</span> projects
        </div>
      </div>
