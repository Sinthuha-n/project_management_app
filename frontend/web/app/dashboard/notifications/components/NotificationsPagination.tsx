...
import { NOTIFICATIONS_PAGE_SIZE_OPTIONS } from '../types';
...
export function NotificationsPagination({
  ...
  startIndex,
  endIndex,
  pageSizeOptions = NOTIFICATIONS_PAGE_SIZE_OPTIONS,
  onPageChange,
  onPageSizeChange,
  disabled = false,
    ...
    >
      ...
      <div className="flex flex-wrap items-center gap-3 text-xs sm:text-sm text-cu-text-secondary">
        <div className="flex items-center gap-2">
          <label
            htmlFor="notifications-page-size-select"
            className="text-xs font-medium text-cu-text-secondary whitespace-nowrap"
          >
            Rows per page:
          </label>
          <select
            id="notifications-page-size-select"
            value={pageSize}
            disabled={disabled}
        ...
        <div className="text-xs font-medium">
          ...
          of <span className="font-bold text-cu-text-primary">{totalItems}</span> notifications
        </div>
      </div>
